defmodule NYSETL.Engines.E1.Message do
  ...
  def transform({version, row}, file) do
    ...
    new(raw_data: row, checksums: checksums, checksum: checksums.v3, file: file, file_id: file.id, version: version, fields: fields)
  end
  ...
  def parse(%__MODULE__{version: :v3} = message) do
    [
      patient_name_last,
      patient_name_middle,
      patient_name_first,
      ...
      eclrs_hospitalized,
      eclrs_icu,
      eclrs_congregate_care_resident,
      eclrs_pregnant,
      result
    ] = message.fields

    %{
      aoe_date: to_utc_datetime(aoe_date),
      county_id: String.to_integer(county_fips_code),
      eclrs_congregate_care_resident: eclrs_congregate_care_resident,
      eclrs_create_date: to_utc_datetime(obxcreatedate),
      eclrs_hospitalized: eclrs_hospitalized,
      eclrs_icu: eclrs_icu,
      eclrs_pregnant: eclrs_pregnant,
      eclrs_symptom_onset_date: to_utc_datetime(eclrs_symptom_onset_date),
      eclrs_symptomatic: eclrs_symptomatic,
      employee_job_title: employee_job_title,
      employee_number: employee_number,
      employer_address: employer_address,
      employer_name: employer_name,
      ...
      healthcare_employee: healthcare_employee,
      lab_id: lab_id,
      lab_name: lab_name,
      message_master_key: message_master_key,
      patient_address_1: patient_address_1,
